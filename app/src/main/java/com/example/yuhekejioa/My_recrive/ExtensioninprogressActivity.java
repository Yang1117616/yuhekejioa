...
public class ExtensioninprogressActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extensioninprogress);
                    ...
                    if (code == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(ExtensioninprogressActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void onError(String msg) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        new AlertDialog.Builder(ExtensioninprogressActivity.this)
                                .setMessage(msg)
            ...
            public void onSuccess(String res) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        fileURI = FileProvider.getUriForFile(ExtensioninprogressActivity.this,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.report://汇报界面
                Intent intent1 = new Intent(ExtensioninprogressActivity.this, ReportActivity.class);
