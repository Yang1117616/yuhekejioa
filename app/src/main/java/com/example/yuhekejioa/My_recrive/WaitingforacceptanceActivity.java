...
// 我接收的-------等待验收
public class WaitingforacceptanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waitingforacceptance);
        ...
        NetworkUtils.sendPost(Constant.ip + "/app/task/getTask", hashMap, this, new NetworkUtils.HttpCallback() {
                    ...
                    if (code == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //设置布局管理器
                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(WaitingforacceptanceActivity.this);
                                recyclerview.setLayoutManager(linearLayoutManager);
                                int space = 8;
                                recyclerview.addItemDecoration(new SpacesItemDecoration(space));
                                Waitadapterx adapter = new Waitadapterx(WaitingforacceptanceActivity.this, list);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(WaitingforacceptanceActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void onError(String msg) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new AlertDialog.Builder(WaitingforacceptanceActivity.this)
                                .setMessage(msg)
    ...
    private void initwangluo1(WantBean.DataBean.SysFilesSponsorBean sysFilesSponsorBean) {
        if (loadingDialog == null) {
            loadingDialog = LoadingDialog.createLoadingDialog(WaitingforacceptanceActivity.this, "正在加载中...");
            loadingDialog.show();
        }
            ...
            public void onSuccess(String res) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        fileURI = FileProvider.getUriForFile(WaitingforacceptanceActivity.this,
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(WaitingforacceptanceActivity.this, "无法打开该格式文件", Toast.LENGTH_SHORT).show();
                            if (loadingDialog != null) {
                                loadingDialog.dismiss();
                                loadingDialog = null;
                            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.button_submit://查看每日工作
