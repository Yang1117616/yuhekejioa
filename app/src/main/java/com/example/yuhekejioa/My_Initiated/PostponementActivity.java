...
// 我发起的---------延期不通过
public class PostponementActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView supplementaryexplanation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_postponement);
        ...
        NetworkUtils.sendPost(Constant.ip + "/app/task/getTask", hashMap, this, new NetworkUtils.HttpCallback() {
                    ...
                    if (code == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                supplementaryexplanation.setText(inspectedState);//补充说明
                                ...
                                //设置布局管理器
                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(PostponementActivity.this);
                                recyclerView.setLayoutManager(linearLayoutManager);
                                int space = 8;
                                recyclerView.addItemDecoration(new SpacesItemDecoration(space));
                                Waitadapterx adapter = new Waitadapterx(PostponementActivity.this, list);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(PostponementActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void onError(String msg) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new AlertDialog.Builder(PostponementActivity.this)
                                .setMessage(msg)
    ...
    private void initwangluo1(WantBean.DataBean.SysFilesSponsorBean sysFilesSponsorBean) {
        if (loadingDialog == null) {
            loadingDialog = LoadingDialog.createLoadingDialog(PostponementActivity.this, "正在加载中...");
            loadingDialog.show();
        }
            ...
            public void onSuccess(String res) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        fileURI = FileProvider.getUriForFile(PostponementActivity.this,
                    ...
                    //  Toast.makeText(PostponementActivity.this, "无法打开该格式文件", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void initview() {
        ...
        supplementaryexplanation = findViewById(R.id.supplementaryexplanation);//补充说明
