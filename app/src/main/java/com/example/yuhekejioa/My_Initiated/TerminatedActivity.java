...
// 我发起的--------已终止
public class TerminatedActivity extends AppCompatActivity implements View.OnClickListener {
    private int taskId;
    ...
    private TextView reasonfortermination;//终止原因
    private int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geton);
    ...
    private void initview() {
        ...
        reasonfortermination = findViewById(R.id.reasonfortermination);//终止原因
        ...
        NetworkUtils.sendPost(Constant.ip + "/app/task/getTask", hashMap, this, new NetworkUtils.HttpCallback() {
            ...
            public void onSuccess(JSONObject res) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        String stopReason = data.getString("stopReason");//终止原因
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                reasonfortermination.setText(stopReason);
                                ...
                                //设置布局管理器
                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(TerminatedActivity.this);
                                recyclerview.setLayoutManager(linearLayoutManager);
                                int space = 8;
                                recyclerview.addItemDecoration(new SpacesItemDecoration(space));
                                Waitadapterx adapter = new Waitadapterx(TerminatedActivity.this, list);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(TerminatedActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void onError(String msg) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new AlertDialog.Builder(TerminatedActivity.this)
                                .setMessage(msg)
    ...
    private void initwangluo1(WantBean.DataBean.SysFilesSponsorBean sysFilesSponsorBean) {
        ...
        if (loadingDialog == null) {
            loadingDialog = LoadingDialog.createLoadingDialog(TerminatedActivity.this, "正在加载中...");
            loadingDialog.show();
        }
            ...
            public void onSuccess(String res) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        fileURI = FileProvider.getUriForFile(TerminatedActivity.this,
                    ...
                    // Toast.makeText(TerminatedActivity.this, "无法打开该格式文件", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.back:
                TerminatedActivity.this.finish();
                break;
            case R.id.button_submit:
                Intent intent = new Intent(TerminatedActivity.this, DailyActivity.class);
