...
public class NotreceivedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notreceived);
        ...
        NetworkUtils.sendPost(Constant.ip + "/app/task/getTask", hashMap, this, new NetworkUtils.HttpCallback() {
                    ...
                    if (code == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //设置布局管理器
                                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NotreceivedActivity.this);
                                recyclerView.setLayoutManager(linearLayoutManager);

                                int space = 8;
                                recyclerView.addItemDecoration(new SpacesItemDecoration(space));
                                PendingAdapter adapter = new PendingAdapter(NotreceivedActivity.this, list);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(NotreceivedActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void onError(final String msg) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        new AlertDialog.Builder(NotreceivedActivity.this)
                                .setMessage(msg)
    ...
    private void initwangluo(DeterminBean.DataBean.SysFilesSponsorBean sysFilesSponsorBean) {
        ...
        if (loadingDialog == null) {
            loadingDialog = LoadingDialog.createLoadingDialog(NotreceivedActivity.this, "正在加载中...");
            loadingDialog.show();
        }
            ...
            public void onSuccess(String res) {
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        fileURI = FileProvider.getUriForFile(NotreceivedActivity.this,
                    ...
                    //Toast.makeText(NotreceivedActivity.this, "无法打开该格式文件", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
